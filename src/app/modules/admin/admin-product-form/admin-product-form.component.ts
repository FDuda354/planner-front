      ...
      <div [formGroup]="parentForm" fxLayout="column">
          ...
          <mat-form-field appearance="fill">
            ...
            <div *ngIf="description?.invalid && (description?.dirty || description?.touched)" >
              ...
              <mat-error *ngIf="description?.errors?.['minlength']">Product description must be at least 3 characters long</mat-error>
              <mat-error *ngIf="description?.errors?.['maxlength']">Product description must be at most 255 characters long</mat-error>
            </div>
          </mat-form-field>
          ...
          <mat-form-field appearance="fill">
            ...
            <div *ngIf="category?.invalid && (category?.dirty || category?.touched)" >
              ...
              <mat-error *ngIf="category?.errors?.['minlength']">Product category must be at least 3 characters long</mat-error>
              <mat-error *ngIf="category?.errors?.['maxlength']">Product category must be at most 255 characters long</mat-error>
            </div>
          </mat-form-field>
          ...
          <mat-form-field appearance="fill">
            ...
            <div *ngIf="currency?.invalid && (currency?.dirty || currency?.touched)" >
              ...
              <mat-error *ngIf="currency?.errors?.['minlength']">Currency must be at least 3 characters long</mat-error>
              <mat-error *ngIf="currency?.errors?.['maxlength']">Currency must be at most 255 characters long</mat-error>
            </div>
          </mat-form-field>
